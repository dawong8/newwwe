...
const rawTitleData = {
	...
	"TAG": [
		...
		{ name: "BADDIE BAD", members: ["GINA_FONG","KEISHA_MILLER"], defenses: ["GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)", "GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)", "GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)", "LETHAL DOSE (MORA, STACY)", "LETHAL DOSE (MORA, STACY)", "GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)"] },
	],
	"MENS-TAG": [
