...
const rawTitleData = {
	...
	"HARDCORE": [
		...
		{ name: "SARITA", defenses: ["KEISHA_MILLER", "QUEEN_AMINAT", "KEISHA_MILLER", "KEISHA_MILLER", "MEI_LING"] },
	],
	"US": [
	...
	"ALPHA-TOP": [
		...
		{ name: "CLARKSON_WILDE", defenses: ["ELI_BOLTON", "TOBASCO_CRUZ"] }
	],
	"WORLD-TOP": [
	...
	"TAG": [
		...
		{ name: "LA CHICAS", members: ["GLENDA_SANCHEZ","VALERIA"], defenses: ["DIAMOND RUSH (ELISA_WATERS, SARITA)"] },
	],
	"MENS-TAG": [
	...
	"COED-TAG": [
		...
		{ name: "THE KINGDOM", members: ["ELISA_WATERS","RYAN_TAMER"], defenses: [ "ROLE MODELS (MEI_LING, BRAD_HOLLYWOOD)", "COLOR RANGERS (MORGAN_NITRA, DEO_SPROUTS)",  "THE IT COUPLE (BECCA_FIELDS, STEVEN_VULGAR)"] },
	],
	"TRIOS": [
