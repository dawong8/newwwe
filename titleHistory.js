...
const rawTitleData = {
	"RAW": [
		...
		{ name: "AOD", defenses: ["SUMMER_HAYES","SUMMER_HAYES","SUMMER_HAYES", "ALICIA_BLADE", "ALICIA_BLADE"] },
		{ name: "ALICIA_BLADE", defenses: ["AOD", "AOD", "GIGI_FITNESS", "GIGI_FITNESS", "SUMMER_HAYES", "AOD"] },
		...
		{ name: "GIGI_FITNESS", defenses: ["ALICIA_BLADE", "YESSICA_PEREZ"] },
		{ name: "AOD", defenses: ["GIGI_FITNESS", "ALICIA_BLADE", "GIGI_FITNESS", "RAINY_BRIGHT", "ALICIA_BLADE", "SUMMER_HAYES", "ALICIA_BLADE", "YESSICA_PEREZ"] },
		{ name: "ALICIA_BLADE", defenses: ["AOD"] },
		{ name: "AOD", defenses: ["ALICIA_BLADE", "YESSICA_PEREZ"] },
		{ name: "JORDAN_SKY", defenses: ["AOD", "YESSICA_PEREZ"] },
		"VACATED",
		{ name: "STACY", defenses: ["AOD", "QUEEN_AMINAT"] },
		...
		{ name: "AMELIA_HOPE", defenses: ["MORA", "MORA"] },
		{ name: "AOD", defenses: ["AMELIA_HOPE", "AMELIA_HOPE", "AMELIA_HOPE"] },
		{ name: "ELISA_WATERS", defenses: ["AOD"] },
	...
	"SMACKDOWN": [
		...
		{ name: "RINA", defenses: ["JORDAN_SKY&DRIANA&QUEEN_AMINAT", "DRIANA", "DRIANA", "QUEEN_AMINAT", "SARAH_LAY", "QUEEN_AMINAT", "DRIANA", "SARAH_LAY"] },
		...
		{ name: "RINA", defenses: ["ALICIA_BLADE", "DAISY_MAYFIELD", "ALICIA_BLADE", "CAROLINA_CHAZ", "ALICIA_BLADE", "ALICIA_BLADE", "GLENDA_SANCHEZ", "DRIANA", "DAISY_MAYFIELD", "DAISY_MAYFIELD"] },
		{ name: "DAISY_MAYFIELD", defenses: ["RINA", "ALICIA_BLADE", "ALICIA_BLADE", "RINA", "GRETCHEN"] },
		{ name: "GLENDA_SANCHEZ", defenses: ["DAISY_MAYFIELD", "RINA"] },
		{ name: "DAISY_MAYFIELD", defenses: ["GLENDA_SANCHEZ", "DRIANA"] },
	...
	"NXT": [
		...
		{ name: "GIA_GO", defenses: ["AMELIA_HOPE", "AMELIA_HOPE&SHAYLA_LA"] },
		{ name: "AMELIA_HOPE", defenses: ["GIA_GO", "VALERIA", "GIA_GO"] },
		{ name: "GIA_GO", defenses: ["AMELIA_HOPE", "LILY_JUNE", "LILY_JUNE", "VALERIA"] },
		{ name: "SARITA", defenses: ["GIA_GO", "VALERIA", "LAGUNA_BLUE"] },
		{ name: "LAGUNA_BLUE", defenses: ["SARITA"] },
		{ name: "VALERIA", defenses: ["LAGUNA_BLUE", "LAGUNA_BLUE"] },
		{ name: "YUNI_JANS", defenses: ["VALERIA", "HONEY_BEATRIX"] },
		{ name: "TASHA_BEE", defenses: ["YUNI_JANS"] },
		{ name: "YUNI_JANS", defenses: ["LAGUNA_BLUE&TASHA_BEE", "TASHA_BEE", "LESLIE_FAYE"] },
	],
	"HARDCORE": [
		...
		{ name: "MORGAN_NITRA", defenses: ["RAINY_BRIGHT","MEI_LING", "GIGI_FITNESS"] },
		{ name: "GINA_FONG", defenses: ["MORGAN_NITRA", "GLENDA_SANCHEZ&RAINY_BRIGHT"] },
		...
		{ name: "CAROLINA_CHAZ", defenses: ["RAINY_BRIGHT", "STACY-DQ", "GLENDA_SANCHEZ", "GLENDA_SANCHEZ"] },
		{ name: "YESSICA_PEREZ", defenses: ["CAROLINA_CHAZ"] },
		{ name: "MORA", defenses: ["YESSICA_PEREZ&STACY", "CAROLINA_CHAZ", "MORGAN_NITRA", "YESSICA_PEREZ"] },
		{ name: "GINA_FONG", defenses: ["MORA", "MORGAN_NITRA", "ELISA_WATERS-DQ"] },
		{ name: "ELISA_WATERS", defenses: ["GINA_FONG"] },
		...
		{ name: "SHAYLA_LA", defenses: ["KATIE_LANG", "TT_SLIM", "QUEEN_AMINAT&MORGAN_NITRA&KATIE_LANG", "YESSICA_PEREZ"] },
		{ name: "QUEEN_AMINAT", defenses: ["YESSICA_PEREZ&SHAYLA_LA&LILY_JUNE"] },
		{ name: "LILY_JUNE", defenses: ["SHAYLA_LA&QUEEN_AMINAT", "QUEEN_AMINAT", "QUEEN_AMINAT"] },
		{ name: "KATIE_LANG", defenses: ["LILY_JUNE", "LILY_JUNE"] },
		{ name: "KEISHA_MILLER", defenses: ["KATIE_LANG", "KATIE_LANG"] },
		{ name: "QUEEN_AMINAT", defenses: ["KEISHA_MILLER"] },
		{ name: "KEISHA_MILLER", defenses: ["QUEEN_AMINAT"] },
	...
	"US": [
		...
		{ name: "DAISY_MAYFIELD", defenses: ["SARAH_LAY","TT_SLIM","BECCA_FIELDS", "QUEEN_AMINAT"] },
		...
		{ name: "RAINY_BRIGHT", defenses: ["GIGI_FITNESS"] },
	],
	"ALPHA-TOP": [
		...
		{ name: "TRAVIS_WEST", defenses: ["TOBASCO_CRUZ&NOAH_ACE","HUGGIE_HOBBS","TOBASCO_CRUZ","BRADLY_WEST","TOBASCO_CRUZ&BRADLY_WEST"] },
		{ name: "BRADLY_WEST", defenses: ["TRAVIS_WEST","BILLY_PONG", "TRAVIS_WEST", "TOBASCO_CRUZ"] },
		{ name: "NOAH_ACE", defenses: ["BRADLY_WEST", "TOBASCO_CRUZ"] },
		...
		{ name: "TOBASCO_CRUZ", defenses: ["BILLY_PONG"] },
		{ name: "TRAVIS_WEST", defenses: ["TOBASCO_CRUZ"] },
		{ name: "FENIX", defenses: ["TRAVIS_WEST"] },
		...
		{ name: "NOAH_ACE", defenses: ["TOBASCO_CRUZ", "TIM_TALL"] },
		...
		{ name: "ELI_BOLTON", defenses: ["R_BABY&DEO_SPROUTS"] },
		{ name: "CLARKSON_WILDE", defenses: ["ELI_BOLTON"] }
	],
	"WORLD-TOP": [
		...
		"VACATED",
		{ name: "VIKTOR_MAXX", defenses: ["CLARKSON_WILDE","BRAD_HOLLYWOOD","BRAD_HOLLYWOOD&CLARKSON_WILDE"] },
		{ name: "CLARKSON_WILDE", defenses: ["VIKTOR_MAXX","KYLER_BLAKE-DQ","BRADLY_WEST-DQ","KYLER_BLAKE"] },
		{ name: "BRAD_HOLLYWOOD", defenses: ["CLARKSON_WILDE"] },
		{ name: "CLARKSON_WILDE", defenses: ["BRAD_HOLLYWOOD","BILLY_PONG"] },
		...
		{ name: "VIKTOR_MAXX", defenses: ["STEVEN_VULGAR", "CLARKSON_WILDE"] },
		{ name: "STEVEN_VULGAR", defenses: ["BRAD_HOLLYWOOD&VIKTOR_MAXX&CLARKSON_WILDE", "HUGGIE_HOBBS"] },
		{ name: "KYLER_BLAKE", defenses: ["STEVEN_VULGAR", "STEVEN_VULGAR", "CLARKSON_WILDE", "BRAD_HOLLYWOOD", "BRAD_HOLLYWOOD", "VIKTOR_MAXX"] },
		{ name: "RYAN_TAMER", defenses: ["KYLER_BLAKE", "CLARKSON_WILDE"] },
		{ name: "KYLER_BLAKE", defenses: ["RYAN_TAMER", "BRAD_HOLLYWOOD", "STEVEN_VULGAR"] },
		{ name: "STEVEN_VULGAR", defenses: ["KYLER_BLAKE", "CLARKSON_WILDE"] },
	...
	"MENS-NXT": [
		...
		"VACATED",
		{ name: "BRAD_HOLLYWOOD", defenses: ["TOBASCO_CRUZ&CLARKSON_WILDE&VIKTOR_MAXX","PETER_PONG&VIKTOR_MAXX","PETER_PONG","PETER_PONG&BILLY_PONG","NOAH_ACE","KYLER_BLAKE","HUGGIE_HOBBS"] },
		{ name: "ELI_BOLTON", defenses: ["BRAD_HOLLYWOOD"] },
		...
		{ name: "PETER_PONG", defenses: ["BILLY_PONG", "PRINCE_EVEREST", "DILLY_DAM&PRINCE_EVEREST", "COLE_FARRIS"] },
		{ name: "OLIVER_CHASE", defenses: ["PETER_PONG"] },
		{ name: "PRINCE_EVEREST", defenses: ["OLIVER_CHASE"] },
	],
	"DOM-TOP": [
	...
	"TAG": [
		...
		{ name: "GOLDEN SUN", members: ["SUMMER_HAYES","MEI_LING"], defenses: ["HOT BITCHES (BECCA_FIELDS, GIGI_FITNESS)","THE PYRAMID (RINA, KEISHA_MILLER)", "THE PYRAMID (RINA, KEISHA_MILLER)", "THE PYRAMID (RINA, KEISHA_MILLER)"] },
		{ name: "THE PYRAMID", members: ["KEISHA_MILLER","RINA"], defenses: ["GOLDEN SUN (SUMMER_HAYES, MEI_LING)", "BECCA & DAISY (BECCA_FIELDS, DAISY_MAYFIELD)", "GOLDEN SUN (SUMMER_HAYES, MEI_LING)", "BECCA & DAISY (BECCA_FIELDS, DAISY_MAYFIELD)", "BECCA & DAISY (BECCA_FIELDS, DAISY_MAYFIELD)-DQ"] },
		{ name: "BECCA & DAISY", members: ["BECCA_FIELDS","DAISY_MAYFIELD"], defenses: ["THE PYRAMID (RINA, KEISHA_MILLER)", "THE PYRAMID (QUEEN_AMINAT, KEISHA_MILLER)"] },
		...
		{ name: "LETHAL DOSE", members: ["MORA","STACY"], defenses: ["GOLDEN SUN (SUMMER_HAYES, MEI_LING)", "GOLDEN SUN (SUMMER_HAYES, MEI_LING)", "CAROLINA CHAZ & GLENDA SANCHEZ", "GOLDEN SUN (SUMMER_HAYES, MEI_LING)", "GOLDEN SUN (SUMMER_HAYES, MEI_LING)-DQ", "MYSTIC ENCHANT (DRIANA, GRETCHEN)-DQ"] },
		{ name: "GOLDEN SUN", members: ["SUMMER_HAYES","MEI_LING"], defenses: ["LETHAL DOSE (MORA, STACY)"] },
		{ name: "THE PYRAMID", members: ["QUEEN_AMINAT","KEISHA_MILLER"], defenses: ["GOLDEN SUN (SUMMER_HAYES, MEI_LING)", "LETHAL DOSE (MORA, STACY)"] },
		{ name: "DEAN'S LIST", members: ["JORDAN_SKY","KATIE_LANG"], defenses: ["THE PYRAMID (QUEEN_AMINAT, KEISHA_MILLER)", "LETHAL DOSE (MORA, STACY)", "THE PYRAMID (QUEEN_AMINAT, KEISHA_MILLER)", "LETHAL DOSE (MORA, STACY)"] },
		{ name: "LETHAL DOSE", members: ["MORA","STACY"], defenses: ["DEAN'S LIST (JORDAN_SKY, KATIE_LANG)", "DEAN'S LIST (JORDAN_SKY, KATIE_LANG)", "THE PYRAMID (QUEEN_AMINAT, KEISHA_MILLER)"] },
		{ name: "DEAN'S LIST", members: ["AMELIA_HOPE","KATIE_LANG"], defenses: ["LETHAL DOSE (MORA, STACY)"] },
		{ name: "GLOOM ANARCHY", members: ["BONNIE_REN","ELLA_THORN"], defenses: ["DEAN'S LIST (AMELIA_HOPE, KATIE_LANG)"] },
		{ name: "BADDIE BAD", members: ["GINA_FONG","KEISHA_MILLER"], defenses: ["GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)", "GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)", "GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)", "LETHAL DOSE (MORA, STACY)", "LETHAL DOSE (MORA, STACY)", "GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)", "GO GETTERS (GIA_GO, CAROLINA_CHAZ)", "GO GETTERS (GIA_GO, CAROLINA_CHAZ)", "GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)"] },
		{ name: "DIAMOND RUSH", members: ["ELISA_WATERS","SARITA"], defenses: ["BADDIE BAD (GINA_FONG, KEISHA_MILLER)", "GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)", "LETHAL DOSE (MORA, STACY)", "BADDIE BAD (GINA_FONG, KEISHA_MILLER)"] },
		{ name: "GO GETTERS", members: ["GIA_GO","CAROLINA_CHAZ"], defenses: ["DIAMOND RUSH (ELISA_WATERS, SARITA)", "THE BUMBLESLUTS (HONEY_BEATRIX, TASHA_BEE)"] },
		{ name: "GLOOM ANARCHY", members: ["BONNIE_REN","ELLA_THORN"], defenses: ["GO GETTERS (GIA_GO, CAROLINA_CHAZ)", "BADDIE BAD (GINA_FONG, SHAYLA_LA)", "GO GETTERS (GIA_GO, CAROLINA_CHAZ)-DQ", "BADDIE BAD (GINA_FONG, SHAYLA_LA)"] },
		{ name: "GO GETTERS", members: ["GIA_GO","CAROLINA_CHAZ"], defenses: ["GLOOM ANARCHY (BONNIE_REN, ELLA_THORN) & BADDIE BAD (GINA_FONG, SHAYLA_LA)", "BADDIE BAD (GINA_FONG, SHAYLA_LA)", "LETHAL DOSE (MORA, STACY)"] },
		{ name: "THE GLAMAZONS", members: ["DRIANA","ALICIA_BLADE"], defenses: ["GO GETTERS (GIA_GO, CAROLINA_CHAZ)", "LETHAL DOSE (MORA, STACY)", "BADDIE BAD (GINA_FONG, SHAYLA_LA)", "GO GETTERS (GIA_GO, CAROLINA_CHAZ)"] },
		{ name: "BADDIE BAD", members: ["GINA_FONG","SHAYLA_LA"], defenses: ["THE GLAMAZONS (DRIANA, ALICIA_BLADE)", "LETHAL DOSE (MORA, STACY)", "GO GETTERS (GIA_GO, CAROLINA_CHAZ)-DQ"] },
		{ name: "GO GETTERS", members: ["GIA_GO","CAROLINA_CHAZ"], defenses: ["BADDIE BAD (GINA_FONG, SHAYLA_LA)", "LA CHICAS (VALERIA, GLENDA_SANCHEZ)", "LA CHICAS (VALERIA, GLENDA_SANCHEZ)", "THE BUMBLESLUTS (HONEY_BEATRIX, TASHA_BEE)-DQ"] },
		{ name: "THE BUMBLESLUTS", members: ["HONEY_BEATRIX","TASHA_BEE"], defenses: ["GO GETTERS (GIA_GO, CAROLINA_CHAZ)"] },
	],
	"MENS-TAG": [
		...
		{ name: "PONG BROS", members: ["PETER_PONG","BILLY_PONG"], defenses: ["TONY TIME (TONY_DASHER, TONY_TORNADO)"] },
		...
		{ name: "KARATE KIDZ", members: ["KYLER_BLAKE","XION_OWENS"], defenses: ["FLYING FUEGOS (TRAVIS_WEST, TOBASCO_CRUZ)", "FLYING FUEGOS (TRAVIS_WEST, TOBASCO_CRUZ)"] },
		{ name: "PONG BROS", members: ["PETER_PONG","BILLY_PONG"], defenses: ["KARATE KIDZ (KYLER_BLAKE, XION_OWENS)", "KARATE KIDZ (KYLER_BLAKE, XION_OWENS)", "KARATE KIDZ (KYLER_BLAKE, XION_OWENS)", "HUGGIE & NOAH (HUGGIE_HOBBS, NOAH_ACE)", "KARATE KIDZ (KYLER_BLAKE, XION_OWENS)", "ROUGH RIDERS (NOAH_ACE, CLARKSON_WILDE)" ] },
		...
		{ name: "PONG BROS", members: ["PETER_PONG","BILLY_PONG"], defenses: [ "COLOR RANGERS (DEO_SPROUTS, HUGGIE_HOBBS)", "COLOR RANGERS (DEO_SPROUTS, HUGGIE_HOBBS)", "KARATE KIDZ (KYLER_BLAKE, XION_OWENS)", "ROUGH RIDERS (CLARKSON_WILDE, NOAH_ACE)", "COLE & RYAN (COLE_FARRIS, RYAN_TAMER)"] },
		...
		{ name: "THE FRATERNITY", members: ["OLIVER_CHASE","ADAM_LOCKY"], defenses: [ "BILLY & DILLY (BILLY_PONG, DILLY_DAM)"] },
	],
	"COED-TAG": [
		...
		{ name: "URBAN LEGENDS", members: ["TT_SLIM","TRAVIS_WEST"], defenses: [ "COLOR RANGERS (MORGAN_NITRA, DEO_SPROUTS)", "COLOR RANGERS (MORGAN_NITRA, DEO_SPROUTS)", "COLOR RANGERS (MORGAN_NITRA, DEO_SPROUTS)-DQ", "ROLE MODELS (MEI_LING, BRAD_HOLLYWOOD)", "MASTERCLASS (MEI_LING, BRAD_HOLLYWOOD)"] },
		...
		{ name: "THE KINGDOM", members: ["ELISA_WATERS","RYAN_TAMER"], defenses: [ "ROLE MODELS (MEI_LING, BRAD_HOLLYWOOD)", "COLOR RANGERS (MORGAN_NITRA, DEO_SPROUTS)"] },
	],
	"TRIOS": [
