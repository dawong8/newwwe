...
const rawTitleData = {
	...
	"SMACKDOWN": [
		...
		{ name: "DAISY_MAYFIELD", defenses: ["SUMMER_HAYES"] },
	],
	"NXT": [
	...
	"WORLD-TOP": [
		...
		{ name: "RYAN_TAMER", defenses: ["BIG_ROD", "BILLY_PONG"] },
	],
	"MENS-NXT": [
	...
	"TAG": [
		...
		{ name: "BADDIE BAD", members: ["GINA_FONG","SHAYLA_LA"], defenses: ["THE GLAMAZONS (DRIANA, ALICIA_BLADE)"] },
	],
	"MENS-TAG": [
	...
	"COED-TAG": [
		...
		{ name: "ROLE MODELS", members: ["MEI_LING","BRAD_HOLLYWOOD"], defenses: [ "THE IT COUPLE (BECCA_FIELDS, STEVEN_VULGAR)"] },
	],
	"TRIOS": [
