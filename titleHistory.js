...
const rawTitleData = {
	...
	"TAG": [
		...
		{ name: "GO GETTERS", members: ["GIA_GO","CAROLINA_CHAZ"], defenses: ["BADDIE BAD (GINA_FONG, SHAYLA_LA)", "LAS CHICAS (VALERIA, GLENDA_SANCHEZ)", "LAS CHICAS (VALERIA, GLENDA_SANCHEZ)", "THE BUMBLESLUTS (HONEY_BEATRIX, TASHA_BEE)-DQ"] },
