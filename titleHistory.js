...
const rawTitleData = {
	"RAW": [
		...
		{ name: "ALICIA_BLADE", defenses: ["AOD", "AOD", "GIGI_FITNESS"] }
	],
	"SMACKDOWN": [
		...
		{ name: "DRIANA", defenses: ["JORDAN_SKY"] }
	],
	"NXT": [
	...
	"HARDCORE": [
		...
		{ name: "GINA_FONG", defenses: ["MORGAN_NITRA"] }
	],
	"US": [
		...
		{ name: "DAISY_MAYFIELD", defenses: ["QUEEN_AMINAT", "QUEEN_AMINAT", "KEISHA_MILLER", "QUEEN_AMINAT", "QUEEN_AMINAT"] },
	],
	"ALPHA-TOP": [
	...
	"WORLD-TOP": [
		...
		{ name: "VIKTOR_MAXX", defenses: ["PETER_PONG","NOAH_ACE", "BRAD_WOODS-DQ", "BRAD_WOODS", "XION_OWENS"] }
	...
	"TAG": [
		...
		{ name: "THE PYRAMID", members: ["KEISHA_MILLER","RINA"], defenses: ["GOLDEN SUN (SUMMER_HAYES, MEI_LING)", "BECCA & DAISY (BECCA_FIELDS, DAISY_MAYFIELD)", "GOLDEN SUN (SUMMER_HAYES, MEI_LING)", "BECCA & DAISY (BECCA_FIELDS, DAISY_MAYFIELD)"] }
	...
	"MENS-TAG": [
		...
		{ name: "PONG BROS", members: ["PETER_PONG","BILLY_PONG"], defenses: ["KARATE KIDZ (KYLER_BLAKE, XION_OWENS)"] },
	],
	"TRIOS": [
