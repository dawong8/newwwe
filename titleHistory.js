...
const rawTitleData = {
	...
	"WORLD-TOP": [
		...
		{ name: "RYAN_TAMER", defenses: ["BIG_ROD", "BILLY_PONG", "KYLER_BLAKE", "BRADLY_WEST", "BIG_ROD"] },
	],
	"MENS-NXT": [
	...
	"TAG": [
		...
		{ name: "GO GETTERS", members: ["GIA_GO","CAROLINA_CHAZ"], defenses: ["BADDIE BAD (GINA_FONG, SHAYLA_LA)"] },
	],
	"MENS-TAG": [
		...
		{ name: "BILLY & DILLY", members: ["BILLY_PONG","DILLY_DAM"], defenses: [ "CHOCO THUNDER (ELI_BOLTON, HUGGIE_HOBBS)", "THE FRATERNITY (OLIVER_CHASE, ADAM_LOCKY)", "THE FRATERNITY (OLIVER_CHASE, ADAM_LOCKY)-DQ", "THE FRATERNITY (OLIVER_CHASE, ADAM_LOCKY)"] },
	],
	"COED-TAG": [
		...
		{ name: "ROLE MODELS", members: ["MEI_LING","BRAD_HOLLYWOOD"], defenses: [ "THE IT COUPLE (BECCA_FIELDS, STEVEN_VULGAR)", "URBAN LEGENDS (TT_SLIM, TRAVIS_WEST)"] },
	],
	"TRIOS": [
