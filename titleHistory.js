...
const rawTitleData = {
	...
	"SMACKDOWN": [
		...
		{ name: "DAISY_MAYFIELD", defenses: ["RINA", "ALICIA_BLADE", "ALICIA_BLADE", "RINA"] }
	],
	"NXT": [
	...
	"HARDCORE": [
		...
		{ name: "KATIE_LANG", defenses: ["LILY_JUNE"] },
	],
	"US": [
	...
	"ALPHA-TOP": [
		...
		{ name: "DILLY_DAM", defenses: ["OLIVER_CHASE", "OLIVER_CHASE", "FENIX", "TIM_TALL", "TOBASCO_CRUZ"] } 
	],
	"WORLD-TOP": [
		...
		{ name: "BIG_ROD", defenses: ["KYLER_BLAKE&VIKTOR_MAXX", "VIKTOR_MAXX-DQ", "BRADLY_WEST", "PETER_PONG", "STEVEN_VULGAR"] }
	],
	"MENS-NXT": [
	...
	"TAG": [
		...
		{ name: "DIAMOND RUSH", members: ["ELISA_WATERS","SARITA"], defenses: ["BADDIE BAD (GINA_FONG, KEISHA_MILLER)", "GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)", "LETHAL DOSE (MORA, STACY)", "BADDIE BAD (GINA_FONG, KEISHA_MILLER)", "THE BUMBLESLUTS (BEATRIX_HUM, TASHA_BUZZER)"] },
		{ name: "GO GETTERS", members: ["GIA_GO","CAROLINA_CHAZ"], defenses: ["DIAMOND RUSH (ELISA_WATERS, SARITA)"] },
	],
	"MENS-TAG": [
