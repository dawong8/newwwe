...
const rawTitleData = {
	...
	"SMACKDOWN": [
		...
		{ name: "GLENDA_SANCHEZ", defenses: ["DAISY_MAYFIELD"] },
	],
	"NXT": [
	...
	"WORLD-TOP": [
		...
		{ name: "BIG_ROD", defenses: ["KYLER_BLAKE&VIKTOR_MAXX", "VIKTOR_MAXX-DQ", "BRADLY_WEST", "PETER_PONG", "STEVEN_VULGAR", "COLE_FARRIS", "RYAN_TAMER-DQ", "RYAN_TAMER", "BRADLY_WEST"] }
	],
	"MENS-NXT": [
	...
	"TAG": [
		...
		{ name: "GO GETTERS", members: ["GIA_GO","CAROLINA_CHAZ"], defenses: ["GLOOM ANARCHY (BONNIE_REN, ELLA_THORN) & BADDIE BAD (GINA_FONG, SHAYLA_LA)"] },
	],
	"MENS-TAG": [
		...
		{ name: "PONG BROS", members: ["PETER_PONG","BILLY_PONG"], defenses: [ "COLOR RANGERS (DEO_SPROUTS, HUGGIE_HOBBS)", "COLOR RANGERS (DEO_SPROUTS, HUGGIE_HOBBS)", "KARATE KIDZ (KYLER_BLAKE, XION_OWENS)"] },
	],
	"COED-TAG": [
		...
		{ name: "THE GIANTS", members: ["DRIANA","TIM_TALL"], defenses: [ "URBAN LEGENDS (TT_SLIM, TRAVIS_WEST"] },
	],
	"TRIOS": [
