...
const rawTitleData = {
	...
	"WORLD-TOP": [
		...
		{ name: "VIKTOR_MAXX", defenses: ["PETER_PONG","NOAH_ACE"] }
	...
	"TAG": [
		...
		{ name: "GOLDEN SUN", members: ["SUMMER_HAYES","MEI_LING"], defenses: ["HOT BITCHES (BECCA_FIELDS, GIGI_FITNESS)","THE PYRAMID (RINA, KEISHA_MILLER)", "THE PYRAMID (RINA, KEISHA_MILLER)"] }
	],
	"MENS-TAG": [
