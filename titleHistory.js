...
const rawTitleData = {
	...
	"TAG": [
		...
		{ name: "TWICE EFFECT", members: ["MORA","STACY"], defenses: ["GOLDEN SUN (SUMMER_HAYES, MEI_LING)", "GOLDEN SUN (SUMMER_HAYES, MEI_LING)", "CAROLINA CHAZ & GLENDA SANCHEZ", "GOLDEN SUN (SUMMER_HAYES, MEI_LING)", "GOLDEN SUN (SUMMER_HAYES, MEI_LING)-DQ", "MYSTIC ENCHANT (DRIANA, GRETCHEN)-DQ"] },
		{ name: "GOLDEN SUN", members: ["SUMMER_HAYES","MEI_LING"], defenses: ["TWICE EFFECT (MORA, STACY)"] },
		{ name: "THE PYRAMID", members: ["QUEEN_AMINAT","KEISHA_MILLER"], defenses: ["GOLDEN SUN (SUMMER_HAYES, MEI_LING)", "TWICE EFFECT (MORA, STACY)"] },
		{ name: "DEAN'S LIST", members: ["JORDAN_SKY","KATIE_LANG"], defenses: ["THE PYRAMID (QUEEN_AMINAT, KEISHA_MILLER)", "TWICE EFFECT (MORA, STACY)", "THE PYRAMID (QUEEN_AMINAT, KEISHA_MILLER)", "TWICE EFFECT (MORA, STACY)"] },
		{ name: "TWICE EFFECT", members: ["MORA","STACY"], defenses: ["DEAN'S LIST (JORDAN_SKY, KATIE_LANG)", "DEAN'S LIST (JORDAN_SKY, KATIE_LANG)", "THE PYRAMID (QUEEN_AMINAT, KEISHA_MILLER)"] },
		{ name: "DEAN'S LIST", members: ["AMELIA_HOPE","KATIE_LANG"], defenses: ["TWICE EFFECT (MORA, STACY)"] },
		{ name: "GLOOM ANARCHY", members: ["BONNIE_REN","ELLA_THORN"], defenses: ["DEAN'S LIST (AMELIA_HOPE, KATIE_LANG)"] },
		{ name: "BADDIE BAD", members: ["GINA_FONG","KEISHA_MILLER"], defenses: ["GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)", "GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)", "GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)", "TWICE EFFECT (MORA, STACY)", "TWICE EFFECT (MORA, STACY)", "GLOOM ANARCHY (BONNIE_REN, ELLA_THORN)"] },
	],
	"MENS-TAG": [
	...
	"COED-TAG": [
		...
		{ name: "URBAN LEGENDS", members: ["TT_SLIM","TRAVIS_WEST"], defenses: [ "COLOR RANGERS (MORGAN_NITRA, DEO_SPROUTS)"] },
	],
	"TRIOS": [
