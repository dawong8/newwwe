...
const rawTitleData = {
	...
	"SMACKDOWN": [
		...
		{ name: "DAISY_MAYFIELD", defenses: ["SUMMER_HAYES", "DRIANA"] },
	],
	"NXT": [
	...
	"ALPHA-TOP": [
		...
		{ name: "DEO_SPROUTS", defenses: ["BILLY_PONG", "TOBASCO_CRUZ"] }
	],
	"WORLD-TOP": [
		...
		{ name: "RYAN_TAMER", defenses: ["BIG_ROD", "BILLY_PONG", "KYLER_BLAKE"] },
	],
	"MENS-NXT": [
	...
	"TAG": [
		...
		{ name: "BADDIE BAD", members: ["GINA_FONG","SHAYLA_LA"], defenses: ["THE GLAMAZONS (DRIANA, ALICIA_BLADE)", "LETHAL DOSE (MORA, STACY)"] },
	],
	"MENS-TAG": [
		...
		{ name: "BILLY & DILLY", members: ["BILLY_PONG","DILLY_DAM"], defenses: [ "CHOCO THUNDER (ELI_BOLTON, HUGGIE_HOBBS)"] },
	],
	"COED-TAG": [
